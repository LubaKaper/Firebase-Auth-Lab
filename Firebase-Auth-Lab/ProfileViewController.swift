...
class ProfileViewController: UIViewController {
    ...
    private func updayeUI() {
        guard let user = Auth.auth().currentUser else {
            return
        }
        emailLabel.text = user.email
        displayNameTextField.text = user.displayName
        phoneTextFiled.text = user.phoneNumber
    ...
    @IBAction func updateProfileButton(_ sender: UIButton ){
        guard let displayName = displayNameTextField.text,
            ...
            let selectedImage = selectedImage else {
                self.showAlert(title: "Wait", message: "You have missing fields")
                return
        }
    ...
    @IBAction func updateProfilePhoto(_ sender: UIButton) {
    ...
    do {
        ...
        UIViewController.showViewCintroller(storyboardName: "Main", viewControllerID: "LoginViewController")
    } catch {
        DispatchQueue.main.async {
